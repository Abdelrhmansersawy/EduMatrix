                ...
                authService.login(emailField.getText(), passwordField.getText())
                        .ifPresentOrElse(
                                user -> {
                                    ...
                                    switch (user.getRole()){
                                        case ADMIN:
                                            navigateTo("/org/example/system/views/adminDashboard.fxml", "Dashboard", loginButton);
                                            break;
                                        case TEACHER:
                                            navigateTo("/org/example/system/views/teacherDashboard.fxml", "Dashboard", loginButton);
                                            break;
                                        case STUDENT:
                                            navigateTo("/org/example/system/views/studentDashboard.fxml", "Dashboard", loginButton);
                                            break;
                                    }
